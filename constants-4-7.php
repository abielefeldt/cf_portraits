...
const PEOPLE = [
  ['_None', 'AriaA', 'YangX', 'EvelH', 'FyraF', 'CaesL', '_Enki'],
  ['TsuwA', 'HiroM', 'MinaC', 'PettT', 'InneL', '_Enki', '_Enki'],
  ['DyrmT', 'AkiiS', 'Mai_P', 'TishB', 'Rin_S', '_Enki', '_Enki'],
  ['HinnL', 'PierT', 'AnaiM', 'ZashZ', 'FaieN', '_Enki', '_None']
];
